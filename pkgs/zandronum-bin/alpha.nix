...
stdenv.mkDerivation rec {
  ...
  version = "3.3-251208-0355";

  src = fetchurl {
    url = "https://zandronum.com/downloads/testing/3.3/ZandroDev3.3-251208-0355linux-x86_64.tar.bz2";
    hash = "sha256-qA9wxVkvXFqOCoQzjIFqv1aOsaOlqNwYQ6WUa+Sg9mM=";
  };
  ...
  installPhase = ''
    ...
    makeWrapper $out/lib/zandronum/zandronum-server $out/bin/zandronum-alpha-server-bin
    makeWrapper $out/lib/zandronum/zandronum $out/bin/zandronum-alpha-bin
    wrapProgram $out/bin/zandronum-alpha-server-bin \
      --set LC_ALL "C"
    wrapProgram $out/bin/zandronum-alpha-bin \
      --set LC_ALL "C"
  '';
